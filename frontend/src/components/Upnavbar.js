...
export function Upnavbar(){
    return(
        <div className="p-1 lg:p-2 border-b border-[#191919] col-span-6 lg:col-span-5 flex items-center justify-between">
            <div className="border border-gray-50 ml-10 lg:ml-6 top-10 hover:border-[#00C0E8]">
